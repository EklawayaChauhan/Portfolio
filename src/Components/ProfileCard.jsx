...
const ProfileCardComponent = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'rgba(249, 115, 22, 0.5)', // Orange themed default
      ...
      <div ref={shellRef} className="relative z-[1] group w-full">
        ...
        >
          ...
          >
            ...
            >
              <img
                className="w-full absolute left-1/2 bottom-[0px] will-change-transform transition-transform duration-[120ms] ease-out object-cover"
                src={avatarUrl}
            ...
            >
              <div className="w-full absolute flex flex-col" style={{ top: '10%', display: 'flex', gridArea: 'auto' }}>
                <h3
                  className="font-bold m-0 tracking-wider"
                  style={{
                    fontSize: 'min(4.5svh, 2.8em)',
